...
class AboutUsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.brown[300], // Set the overall background to cream color
      appBar: PreferredSize(
        preferredSize: Size.fromHeight(100.0), // Increased height for curve effect
        child: ClipPath(
          ...
          child: AppBar(
            ...
            backgroundColor: Colors.brown[50], // Cream color for the AppBar
            elevation: 0, // Removes shadow for a smooth curve
          ),
        ),
      ),
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                        color: Colors.brown[100], // Dark brown text
                      ),
                    ),
                  ],
                ),
                ...
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      color: Colors.brown[50], // Light cream color for background
              ...
              Column(
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
                      color: Colors.brown[50], // Light cream background
                      border: Border.all(color: Color(0xFF6D4C41), width: 1),
                      boxShadow: [
                        BoxShadow(
                          color: Color(0xFF6D4C41).withOpacity(0.3),
