...
import 'package:matrimony_project/api/get_api.dart';
import 'package:matrimony_project/databas_crud.dart';
...
import 'package:matrimony_project/project/splash_screen.dart';
...
//   CrudList crud = CrudList();
//   await crud.addUserInUserTable(
//     Name: "Test User",
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:SplashScreen()
      // FutureBuilder(future: ProjectDb().initDatabase(), builder: (context, snapshot){
